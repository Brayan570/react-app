  ...
  const servicios = [
    {
      ...
      description: "Mejoramos la velocidad y eficiencia de tu sitio web para ofrecer la mejor experiencia de usuario y mejores conversiones.",
    ...
    },
    {
      ...
      description: "Estrategias personalizadas para aumentar tu presencia online, engagement con clientes y generar resultados medibles.",
      image: marketingIcon,
      color: "marketing",
      detalles: {
        beneficios: [
    ...
    },
    {
      ...
      description: "Asistencia continua y mantenimiento profesional para garantizar que tu proyecto digital funcione sin problemas.",
      image: soporteIcon,
      color: "soporte",
      detalles: {
        beneficios: [
      ...
      <div className="servicios-destacados-container">
        ...
        <div className="servicios-grid">
          {servicios.map((servicio, index) => (
            <div key={index} className={`servicio-card ${servicio.color} ${expandedCard === index ? 'expanded' : ''}`}>
              {/* Image Container */}
              ...
              <div className="servicio-content">
                  ...
                  <div className="servicio-detalles">
                    ...
                    <div className="detalle-section">
                      <h4 className="detalle-title">
                        <svg className="detalle-icon" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <div className="metrica-destacada">
                      <svg className="metrica-icon" fill="currentColor" viewBox="0 0 20 20">
                ...
                >
                  ...
                  <svg 
                    className={`cta-icon ${expandedCard === index ? 'rotated' : ''}`} 
                    fill="none" 
                    stroke="currentColor" 
                    viewBox="0 0 24 24"
                  >
